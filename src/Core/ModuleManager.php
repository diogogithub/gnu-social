...
class ModuleManager
{
    protected ServiceLocator $service_locator;
    protected array $modules = [];
    public function __construct(ServiceLocator $service_locator)
    {
        $this->modules         = $service_locator->getProvidedServices();
