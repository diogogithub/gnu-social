...
abstract class I18nHelper
{
     ...
     */
    public static function client_preferred_language(string $http_accept_lang_header): string
    {
        $client_langs  = [];
     ...
     */
    public static function get_nice_language_list(): array
    {
        $nice_lang     = [];
        $all_languages = Common::config('site', 'languages');
     ...
     */
    public static function is_rtl(string $lang_value): bool
    {
